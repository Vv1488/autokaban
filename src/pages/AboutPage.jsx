    ...
    <div className="section">
      <div className="container">
        <Helmet>
          ...
          <meta name="description" content="Інтернет-магазин автотоварів AutoKaban. Інформація про магазин, власника, доставку та оплату." />
        </Helmet>
        <div className="section-title">
          <h2>Про нас</h2>
          <p>AutoKaban — ваш надійний помічник у світі автотоварів</p>
        </div>
        ...
        <div style={styles.content}>
          <div style={styles.block}>
            <h3>🚗 Хто ми?</h3>
            <p style={styles.text}>
              AutoKaban — інтернет-магазин автотоварів та гаджетів для
          ...
          <div style={styles.block}>
            ...
            <p style={styles.text}>
              AutoKaban працює за моделлю прямої доставки. Ми співпрацюємо
